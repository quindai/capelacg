	...
	public capela() {
		...
		addKeyListener(new KeyAdapter() {
	        ...
	        public void keyPressed(KeyEvent e) {
				...
				switch(key){
					case KeyEvent.VK_RIGHT: roda -= 5%360;
						break;
					case KeyEvent.VK_LEFT: roda += 10%360;
						break;
					case KeyEvent.VK_DOWN: rollup += 2.0f;
						break;
					case KeyEvent.VK_UP: rollup -= 2.0f;
						break;
					case KeyEvent.VK_F1: thisFullScreen();
						break;
					case KeyEvent.VK_O:
